...
const updatePopupMessages = defineMessages({
	...
	body: {
		...
		defaultMessage:
			'Crackrinth v{version} is ready to install! Reload to update now, or automatically when you close Crackrinth.',
	},
	meteredBody: {
		id: 'app.update-popup.body.metered',
		defaultMessage: `Crackrinth v{version} is available now! Since you're on a metered network, we didn't automatically download it.`,
	},
	downloadedBody: {
		id: 'app.update-popup.body.download-complete',
		defaultMessage: `Crackrinth v{version} has finished downloading. Reload to update now, or automatically when you close Crackrinth.`,
	},
	linuxBody: {
		id: 'app.update-popup.body.linux',
		defaultMessage:
			'Crackrinth v{version} is available. Use your package manager to update for the latest features and fixes!',
	},
	reload: {
	...
	>
		...
		>
			...
			<OverflowMenu
				...
				v-tooltip.right="`Crackrinth account`"
			...
			<NavButton v-else v-tooltip.right="'Sign in to a Crackrinth account'" :to="() => signIn()">
				<LogInIcon class="text-brand" />
			</NavButton>
		</div>
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			<div data-tauri-drag-region class="flex min-w-0 flex-1 overflow-hidden p-3">
				<span class="h-full flex items-center shrink-0 pointer-events-none font-extrabold text-contrast text-lg tracking-tight">Crackrinth</span>
	...
	>
		<div class="app-viewport flex-grow router-view">
			<transition name="popup-survey">
				...
				>
					<h2 class="text-lg font-extrabold mt-0 mb-2">Hey there Crackrinth user!</h2>
					<p class="m-0 leading-tight">
						Would you mind answering a few questions about your experience with Crackrinth?
					</p>
					<p class="mt-3 mb-4 leading-tight">
						This feedback will help guide future updates!
					</p>
